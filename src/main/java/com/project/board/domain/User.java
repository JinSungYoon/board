...
public class User {
    ...
    public static UserBuilder memberBuilder(String loginId,String password,String nickName) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(userId, loginId, password, nickName, userRoleCode, activeYn, createDate, updateDate);
    }
